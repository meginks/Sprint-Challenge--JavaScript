...
class CubeMaker extends CuboidMaker {
    constructor(cubeProperties) {
        ...
        this.sideLength = cubeProperties.sideLength;
        this.length = cubeProperties.sideLength;
        this.height = cubeProperties.sideLength;
        this.width = cubeProperties.sideLength;
    }
    checkIfCube() {
        if (this.length === this.width === this.height) {
            return true;
        } else {
            return "This is an IMPOSTER CUBE";
        }
    }
}
